var Productspartialview = React.createClass({
...
React.renderComponent(<Productspartialview />, document.getElementById('reactcontent'));
//ReactDOM.renderComponent(<Productspartialview />, document.getElementById('reactproducts'));