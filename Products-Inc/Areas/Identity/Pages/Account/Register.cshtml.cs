...
namespace Products_Inc.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new User { UserName = Input.Email, Email = Input.Email }; // FirstName = Input.FirstName, LastName = Input.LastName, BirthDate = Input.BirthDate }; //Added FirstName,LastName and BirthDate /ER
