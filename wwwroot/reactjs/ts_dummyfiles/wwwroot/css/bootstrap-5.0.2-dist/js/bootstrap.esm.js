...
var Alert = /** @class */ (function (_super) {
    ...
    Alert.prototype._removeElement = function (element) {
        ...
        this._queueCallback(function () { return _this._destroyElement(element); }, element, isAnimated);
    };
...
var Carousel = /** @class */ (function (_super) {
    ...
    Carousel.prototype._getConfig = function (config) {
        config = __assign(__assign(__assign({}, Default$9), Manipulator.getDataAttributes(this._element)), (typeof config === 'object' ? config : {}));
...
var Collapse = /** @class */ (function (_super) {
    ...
    Collapse.prototype._getConfig = function (config) {
        config = __assign(__assign({}, Default$8), config);
    ...
    Collapse.prototype._getParent = function () {
        ...
        SelectorEngine.find(selector, parent).forEach(function (element) {
            ...
            _this._addAriaAndCollapsedClass(selected, [element]);
        });
        return parent;
    };
    ...
    Collapse.collapseInterface = function (element, config) {
        ...
        var _config = __assign(__assign(__assign({}, Default$8), Manipulator.getDataAttributes(element)), (typeof config === 'object' && config ? config : {}));
...
var Dropdown = /** @class */ (function (_super) {
    ...
    Dropdown.dataApiKeydownHandler = function (event) {
        ...
        var getToggleButton = function () { return _this.matches(SELECTOR_DATA_TOGGLE$3) ? _this : SelectorEngine.prev(_this, SELECTOR_DATA_TOGGLE$3)[0]; };
...
var Backdrop = /** @class */ (function () {
    ...
    Backdrop.prototype._getConfig = function (config) {
        config = __assign(__assign({}, Default$6), (typeof config === 'object' ? config : {})); // use getElement() with the default "body" to get a fresh Element on each instantiation
...
var Modal = /** @class */ (function (_super) {
    ...
    Modal.prototype.show = function (relatedTarget) {
        ...
        EventHandler.on(this._element, EVENT_CLICK_DISMISS$2, SELECTOR_DATA_DISMISS$2, function (event) { return _this.hide(event); });
    ...
    Modal.prototype._enforceFocus = function () {
        ...
        EventHandler.on(document, EVENT_FOCUSIN$2, function (event) {
            if (document !== event.target && _this._element !== event.target && !_this._element.contains(event.target)) {
                _this._element.focus();
            }
        });
    };
...
var Offcanvas = /** @class */ (function (_super) {
    ...
    Offcanvas.prototype._enforceFocusOnElement = function (element) {
    ...
    Offcanvas.prototype._addEventListeners = function () {
        var _this = this;
        EventHandler.on(this._element, EVENT_CLICK_DISMISS$1, SELECTOR_DATA_DISMISS$1, function () { return _this.hide(); });
...
var Popover = /** @class */ (function (_super) {
    ...
    Popover.prototype.getTipElement = function () {
        ...
        this.tip = _super.prototype.getTipElement.call(this);
        if (!this.getTitle()) {
    ...
    Popover.prototype._addAttachmentClass = function (attachment) {
...
var Toast = /** @class */ (function (_super) {
    ...
    Toast.prototype._setListeners = function () {
        var _this = this;
        EventHandler.on(this._element, EVENT_CLICK_DISMISS, SELECTOR_DATA_DISMISS, function () { return _this.hide(); });
